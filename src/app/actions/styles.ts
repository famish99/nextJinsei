...
export async function saveStylesAction(styles: StyleConfig): Promise<{ success: boolean; error?: string }> {
  try {
    ...
    const filePath = path.join(process.cwd(), 'src', 'app', 'config', 'styles.json')
